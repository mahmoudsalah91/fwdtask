...
public class invoiceHeaderTableModel extends AbstractTableModel {   
    ...
    private List<InvoiceFrameEntity>invoicesArray;
    private DateFormat df = new SimpleDateFormat("dd-MM-yyyy");
    public invoiceHeaderTableModel(List<InvoiceFrameEntity>invoicesArray) {
...
@Override
   ...
   @Override
    public Object getValueAt(int rowIndex, int columnIndex) {
        InvoiceFrameEntity row =invoicesArray.get(rowIndex);
        switch(columnIndex){
